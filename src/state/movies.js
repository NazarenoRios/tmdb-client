...
export const MovieBannerRequest = createAsyncThunk("MOVIE_BANNER", (get_url) => {
    return axios.get(`${get_url}${requests.fetchAnimation}`, { withCredentials: true, credentials: 'include' })
...
export const MovieDetailRequest = createAsyncThunk("MOVIE_DETAIL", ({get_url, API_KEY, id}) => {
    return axios.get(`${get_url}/movie/${id}${API_KEY}&append_to_response=videos,images`, { withCredentials: true, credentials: 'include' })
      .then(res => res.data)
})
...
export const MovieSearchRequest2 = createAsyncThunk("MOVIE_SEARCH2", ({get_url, setMovies2}) => {
    return axios.get(`${get_url}${requests.fetchTrending}`, { withCredentials: true, credentials: 'include' })
...
export const MovieSetSearch = createAsyncThunk("MOVIE_SET_SEARCH", ({get_url, API_KEY, search, setMovies}) => {
    return axios.get(`${get_url}/search/movie${API_KEY}&query=${search.value}&page=1`, { withCredentials: true, credentials: 'include' })
        .then(res => {
...
export const MovieSetSearch2 = createAsyncThunk("MOVIE_SET_SEARCH2", ({get_url, API_KEY, search, setMovies2}) => {
    return axios.get(`${get_url}/search/movie${API_KEY}&query=${search.value}&page=2`, { withCredentials: true, credentials: 'include' })
        .then(res => {
